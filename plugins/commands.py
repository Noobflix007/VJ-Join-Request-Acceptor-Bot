...
async def start_message(c,m):
    ...
    await m.reply_photo(f"https://te.legra.ph/file/119729ea3cdce4fefb6a1.jpg",
        ...
        reply_markup=InlineKeyboardMarkup(
            [[
                InlineKeyboardButton('🎬 Movies Group ', url='https://t.me/Hindi_movies_noobflix')
            ],[
                InlineKeyboardButton("❣️ ᴅᴇᴠᴇʟᴏᴘᴇʀ", url='http://t.me/Deendayal_dhakad_Contact'),
                InlineKeyboardButton("🌝 ᴜᴘᴅᴀᴛᴇ Channel", url='https://t.me/Noobflixmovies')
            ]]
        )
    )
